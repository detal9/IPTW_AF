...
# L2 = rbinom(n, 1, 0.5);
# A = rbinom(n, 1, plogis(-1 + 0*L1 + 0*L2));
...
file.name = paste("results_scenario0_",gsub("-","",Sys.Date()),".Rdata", sep="");
save(estimates.iptw, cover.iptw, estimates.trad, cover.trad,
     estimates.trad2, cover.trad2, estimates.trad.iptw, cover.trad.iptw,
     estimates.trad2.iptw, cover.trad2.iptw, estimates.averisk, cover.averisk,
